    ...
    <div class="-sriracha-font">
        ...
        <main>
                            ...
                            <div class="col-7">
                                <div class="stand">
                                    <div class="note-card -small">
                                        ...
                                        <div class="note-item">
                                            <p class="px-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum voluptates necessitatibus possimus. Lorem lorem <mark>ipsum dolor</mark> sit amet.</p>
                                        </div>
                                        ...
                                        <div class="note-item px-4">
                                            <p>Lorem <mark>ipsum dolor</mark> sit amet, consectetur adipisicing elit. Excepturi sint eius voluptatem eos alias veniam deserunt hic, suscipit quaerat impedit quisquam rem libero aut.</p>
                                        </div>
                ...
                <div class="demo-block -stand-left">
                    <div class="container">
                        <div class="row">
                            <div class="col-7">
                                <div class="stand">
                                    <div class="note-card -small">
                                        ...
                                        <div class="note-item px-4">
                                            <p>There is also another possible syntax to define stores. Similar to the Vue Composition API's setup function, we can pass in a function that defines reactive properties and methods and returns an object with the properties and methods we want to expose.</p>
                                        </div>
                                        ...
                                        <div class="note-item px-5">
                                            ...
                                            <ul>
                                                <li><mark>ref()</mark>s become state properties</li>
                                                <li><mark>computed()</mark>s become getters</li>
                                                <li><mark>function()</mark>s become actions</li>
                                            </ul>
                                        </div>
                                        <div class="note-item px-4">
                            ...
                            <div class="col-5">
                                <div class="text-description -gabriela-font">
                                    <div class="heading">Дополняйте свои мысли примерами кода, графиками или картинками.</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <ul style="margin-top: 200px;">
                ...
                <li>Показать, что к карточке можно добавить блиц-вопрос. Сделать её может переворачиваемой. Подсказка после ответа юсера.</li>
                <li>В завершение можно написать какой-то текст кому это может быть полезно и, что создаваемыми досками можно делиться.</li>
            </ul>
        </main>
    </div>
</template>
...
import QuestionItem from "./note/noteItems/QuestionItem.vue";
